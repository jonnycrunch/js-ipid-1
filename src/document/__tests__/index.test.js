...
describe('revokeAuthentication', () => {
    it('should revoke authentication successfully', async () => {
        ...
        document.revokeAuthentication(id);
    ...
    it('should not update if no id found', async () => {
        ...
        document.revokeAuthentication(id1);
        expect(document.getContent()).toEqual(content);
...
describe('revokeService', () => {
    it('should revoke service with full id successfully', async () => {
        const fullId = 'did:ipid:QmUTE4cxTxihntPEFqTprgbqyyS9YRaRcC8FXp6PACEjFG;Service1';
        const document = await createDocument(mockKey);

        document.revokeService(fullId);
        expect(document.getContent()).toEqual(mockContent);
    ...
    it('should revoke service with short id successfully', async () => {
        const content = { ...mockContent, service: [mockService1, mockService2] };
        const document = await createDocument(mockKey, content);

        document.revokeService('Service2');
